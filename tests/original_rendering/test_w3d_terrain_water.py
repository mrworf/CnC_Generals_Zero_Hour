...
def main():
    ...
    with TemporaryDirectory(prefix="zh-m22-terrain-water-") as scratch:
        ...
        marker="original terrain water: plane=1 cloud=1 retail-cloud-selector=1 scalar-transaction=1 ordering=1 retry=2 tracks=1 siblings=0 generations=5 resources=0"
