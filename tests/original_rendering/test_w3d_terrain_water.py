...
def main():
    ...
    with TemporaryDirectory(prefix="zh-m22-terrain-water-") as scratch:
        ...
        marker="original terrain water: plane=1 cloud=1 retail-cloud-selector=1 scalar-transaction=1 active-reset=1 ordering=1 retry=2 tracks=1 siblings=0 grid-query=1 override=1 generations=9 resources=0"
