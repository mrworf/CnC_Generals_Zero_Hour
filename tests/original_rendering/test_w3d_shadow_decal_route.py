...
MARKER = "original full feature map: terrain-tracks-shadow-water-particle-smudge=1 failures=2 generations=2 resources=0"
...
def main() -> int:
    ...
    with TemporaryDirectory(prefix="zh-m22-shadow-decal-") as scratch:
        ...
        os.environ["ZH_M22_FULL_FEATURE_PROFILE"] = "1"; os.environ["ZH_M22_SHADOW_DECAL_MAP"] = str(packet)
