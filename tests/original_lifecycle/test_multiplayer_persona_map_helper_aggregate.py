#!/usr/bin/env python3
"""Couple generated source persona/map metadata and map-helper transactions."""
...
EXPECTED = {
    "metadata": "original generated persona/mapcache: generations=2 cache=0",
    "preview": "original generated map preview: generations=2 images=0 pixels=0",
...
def main() -> int:
    ...
    print("original generated multiplayer persona/map-helper aggregate: generations=2 providers=0 pixels=0")
    return 0
