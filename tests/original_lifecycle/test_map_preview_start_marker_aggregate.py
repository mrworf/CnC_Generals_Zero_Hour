#!/usr/bin/env python3
"""Couple generated map-preview and source start-marker helper transactions."""
...
def main() -> int:
    ...
    print("original generated map-preview/start-marker aggregate: generations=2 providers=0 pixels=0")
    return 0
