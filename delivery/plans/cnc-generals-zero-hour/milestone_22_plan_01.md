...
| 06B1 | [milestone_22_plan_01_slice_06b1.md](milestone_22_plan_01_slice_06b1.md) | Canonical original dynamic VB/IB access CPU storage, lock, discard/no-overwrite, offset, reset and bounded physical upload; no skin claim. | slice 06A3C | pending | | |
| 06B2 | [milestone_22_plan_01_slice_06b2.md](milestone_22_plan_01_slice_06b2.md) | Original skinned mesh deform/category draw with exact dynamic normal+diffuse+UV2 source FVF and empty procedural queue. | slice 06B1 | pending | | |
