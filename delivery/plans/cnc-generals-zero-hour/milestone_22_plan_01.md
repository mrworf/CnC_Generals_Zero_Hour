...
| 08B3A | [milestone_22_plan_01_slice_08b3a.md](milestone_22_plan_01_slice_08b3a.md) | Aggregate source buffer-slot and volume-geometry CPU closure. | slices 08B3A1–08B3A2 | pending: records the composed source-compatible geometry prerequisite; no guard is relaxed | | |
