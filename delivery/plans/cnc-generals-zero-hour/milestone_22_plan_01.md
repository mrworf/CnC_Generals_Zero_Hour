...
| 08F0B | [milestone_22_plan_01_slice_08f0b.md](milestone_22_plan_01_slice_08f0b.md) | Close the original display smart asset-purge handoff reached by `loadMapINI` using generated inputs. | slice 08F1 | pending: native Linux display method is fail-closed | | [discovery](../../evidence/cnc-generals-zero-hour/milestone_22_slice_08f0_discovery.md) |
| 08F0 | [milestone_22_plan_01_slice_08f0.md](milestone_22_plan_01_slice_08f0.md) | Explicit test-selector transition through the accepted 08D reset boundary to the first source map-parser boundary. | slices 08D, 08E, 08F0A, 08F0B | pending: source display smart-purge prerequisite; resume existing plan after 08F0B | | [discovery](../../evidence/cnc-generals-zero-hour/milestone_22_slice_08f0_discovery.md) |
| 08F | [milestone_22_plan_01_slice_08f.md](milestone_22_plan_01_slice_08f.md) | Bounded post-map original scenario-construction closure under the accepted redacted Recording route. | slices 08F0, 08F1 | pending | | |
