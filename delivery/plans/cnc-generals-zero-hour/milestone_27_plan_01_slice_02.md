...
Cumulative focused runtime and compile/link/live-symbol identity tests passed 4/4 in GCC/Clang Debug/Release. The ledger and 3,293-path classification checks pass, with only actual manifest-listed `RandomValue.cpp` and `crc.cpp` promoted. Commit: `2fb1a7dc1a2919be7ed43c0fee25e3f1e0fd353d`.
