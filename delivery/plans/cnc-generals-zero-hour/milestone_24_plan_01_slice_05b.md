# M24 slice 05B: original retail skirmish persistence after draw-provider closure
...
An original retail skirmish roundtrip passes full exact source CRC and recovery gates without bypass or renderer substitution. Then commit one coherent 05B slice; otherwise remain pending with the exact M22 blocker.
