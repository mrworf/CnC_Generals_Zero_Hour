...
Port original Xfer traversal, SaveGame, recorder/playback and CRC with bounded fixed-width source-established layouts. Preserve autosave/transactional load and isolate toy ZHSG as fixture-only.
