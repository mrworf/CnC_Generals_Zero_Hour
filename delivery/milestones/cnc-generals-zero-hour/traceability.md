...
Every affected pending milestone consumes the supplement's Fixed decisions and boundaries and Evidence grades and anti-proxy checks, with Engineering order superseded by RC-001–RC-006. No required item is unmapped or blocked by an unresolved product decision.
