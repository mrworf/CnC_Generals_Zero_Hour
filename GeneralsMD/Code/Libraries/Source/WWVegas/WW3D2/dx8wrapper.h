...
using D3DTEXTUREOP = unsigned;
using D3DCMPFUNC = unsigned;
using D3DCOLOR = unsigned;
...
enum {
    ...
    D3DRS_ZBIAS=47, D3DRS_FILLMODE=8, D3DRS_BLENDOP=171,
    D3DRS_PATCHSEGMENTS=164, D3DRS_FOGSTART=36, D3DRS_FOGEND=37,
    D3DRS_COLORVERTEX=141, D3DRS_LOCALVIEWER=142,
    D3DRS_NORMALIZENORMALS=143, D3DRS_SPECULARMATERIALSOURCE=146,
    ...
    D3DBLEND_DESTCOLOR=9, D3DBLENDOP_ADD=1, D3DBLENDOP_REVSUBTRACT=3,
    D3DCMP_LESS=2, D3DCMP_LESSEQUAL=4, D3DCMP_GREATEREQUAL=7,
    ...
    D3DTOP_MODULATE=4, D3DTOP_MODULATE2X=5, D3DTOP_ADD=7,
    D3DTOP_ADDSIGNED=8, D3DTOP_ADDSIGNED2X=9, D3DTOP_SUBTRACT=10,
    D3DTOP_ADDSMOOTH=11, D3DTOP_BLENDTEXTUREALPHA=13,
    D3DTOP_BLENDCURRENTALPHA=14, D3DTOP_MODULATEALPHA_ADDCOLOR=18,
    D3DTOP_BUMPENVMAP=22, D3DTOP_BUMPENVMAPLUMINANCE=23,
    D3DTA_DIFFUSE=0, D3DTA_CURRENT=1, D3DTA_TEXTURE=2,
    D3DTEXOPCAPS_SELECTARG1=1U<<1, D3DTEXOPCAPS_MODULATE=1U<<3,
    D3DTEXOPCAPS_MODULATE2X=1U<<4, D3DTEXOPCAPS_ADD=1U<<6,
    D3DTEXOPCAPS_ADDSIGNED=1U<<7, D3DTEXOPCAPS_ADDSIGNED2X=1U<<8,
    D3DTEXOPCAPS_SUBTRACT=1U<<9, D3DTEXOPCAPS_ADDSMOOTH=1U<<10,
    D3DTEXOPCAPS_BLENDTEXTUREALPHA=1U<<12,
    D3DTEXOPCAPS_BLENDCURRENTALPHA=1U<<13,
    D3DTEXOPCAPS_BUMPENVMAP=1U<<21,
    D3DTEXOPCAPS_BUMPENVMAPLUMINANCE=1U<<22
};
