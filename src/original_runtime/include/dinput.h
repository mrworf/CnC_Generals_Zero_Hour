...
// DirectInput keyboard values are serialized by the original engine.  Keep the
// legacy scan-code ABI on Linux while the SDL platform adapter translates host
// input at the device boundary.
